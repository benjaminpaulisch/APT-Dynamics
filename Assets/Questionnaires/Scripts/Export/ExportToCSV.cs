...
namespace VRQuestionnaireToolkit
{
    public class ExportToCSV : MonoBehaviour
    {
        ...
        public void Save()
        {
            ...
            for (int i = 0; i < _vrQuestionnaireToolkit.GetComponent<GenerateQuestionnaireBeMoBIL>().Questionnaires.Count; i++)
            {
                //if (_vrQuestionnaireToolkit.GetComponent<GenerateQuestionnaire>().Questionnaires[i].gameObject.activeSelf)
                if (_vrQuestionnaireToolkit.GetComponent<GenerateQuestionnaireBeMoBIL>().Questionnaires[i].gameObject.activeSelf)
            ...
            // _completeFileName = [questionnaireID]_[participantID]_[feedbackModality]_[questionnaireName].[fileType]
            string _completeFileName = _questionnaireID + "_" + _studySetup.ParticipantId + "_" /*+ MainLogic.GetComponent<GUIControl>().GetCurrentBlockModality() + "_"*/ + FileName + "." + _fileType;

            //string _completeFileName_allResults = "questionnaireID_" + _questionnaireID + "_ALL_" + FileName + "." + _fileType;
            // _completeFileName_allResults = [questionnaireID]_ALL_[questionnaireName].[fileType]
            string _completeFileName_allResults = _questionnaireID + "_ALL_" + FileName + "." + _fileType;
