...
public class lsl_rb_torso : MonoBehaviour {
	...
	public const string uid = "21da06a47ac14a1a84d56d629d0486e5wegfd";
	...
	// set LSL parameters
	public const string StreamName = "APT_Unity3D_Rigid_Torso";
	...
	private void pushSample()
	{
		...
		else
		{
			...
			currentSample[0] = torso.transform.position.x;
			currentSample[1] = torso.transform.position.y;
			currentSample[2] = torso.transform.position.z;
			currentSample[3] = torso.transform.rotation.x;
			currentSample[4] = torso.transform.rotation.y;
			currentSample[5] = torso.transform.rotation.z;
			currentSample[6] = torso.transform.rotation.w;
