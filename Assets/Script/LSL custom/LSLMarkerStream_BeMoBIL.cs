...
namespace Assets.LSL4Unity.Scripts
{
    ...
    public class LSLMarkerStream_BeMoBIL : MonoBehaviour
    {
        public string lslStreamName = "Unity3D_Marker";
        public string lslStreamType = "Markers";
        public string unique_source_id = "asobuanwe98buo7tiutzuiopüoihj";
        public liblsl.channel_format_t lslChannelFormat = liblsl.channel_format_t.cf_string;
