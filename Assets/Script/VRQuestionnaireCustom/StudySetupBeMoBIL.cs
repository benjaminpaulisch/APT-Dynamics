...
{
    public class StudySetupBeMoBIL : MonoBehaviour
    {
        public string ParticipantId = "";
        public string Condition = "";

        //[BPA: added this for transform data]
        ...
        public bool ConfigurationMode = false;
        [Tooltip("When checked, the scale of the VRQuestionnaireToolkit object in the scene is used for scaling the questionnaires.")]
        ...
        void Start()
        {
            //[BPA: store default transform values]
            //defaultPosition = QuestionRecTest.transform.position;
            defaultPosition = this.transform.position;
            //defaultRotation = Quaternion.identity;
            defaultRotation = this.transform.rotation;
            //defaultScale = QuestionRecTest.transform.localScale;
        ...
        void Update()
        {
            if (ConfigurationMode || EditorMode) AdjustTransform();
        ...
        void SetTransformToDefault()
        {
            ...
            */
            ...
            //[BPA: changed this to use the transform values of the VRQuestionnaireToolkit prefab when the scene was started]
        ...
        void SetTransformToObjectValues()
        {
            //[BPA: added this to use the current transform of the VRQuestionnaireToolkit prefab in the scene]
            this.transform.localPosition = QuestionRecTest.transform.position;
            this.transform.localRotation = Quaternion.identity;
            this.transform.localScale = new Vector3(this.transform.localScale.x * QuestionRecTest.transform.localScale.x, this.transform.localScale.y * QuestionRecTest.transform.localScale.y, this.transform.localScale.z * QuestionRecTest.transform.localScale.z);         
