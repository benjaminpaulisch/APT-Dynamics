...
public class ArmStimulation : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            StimulateArmSinglePulse(testPart, Side.Left, testWidth, testCurrent);
        }
...
//        Debug.Log("Arm Stimulation initialized");
    ...
    public void stimulate(Part part, Side side, int width, int current)
    {
        ...
        Debug.Log("part:"+part+"side:"+side+"width:"+width+"current:"+current);
    ...
    public void stimulateSinglePulse(Part part, Side side, int width, int current)
    {
        ...
        Debug.Log(channel+""+side);
        Debug.Log(width+""+current);
